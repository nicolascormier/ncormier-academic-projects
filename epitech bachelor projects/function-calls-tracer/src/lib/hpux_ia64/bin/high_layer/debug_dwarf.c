...
debugs_t	*Dwarf2_debug_new_from_bin(bin_obj_t *elf)
{
  Elf32_Shdr	*dinfo;
  Elf32_Shdr	*dabbrev;
  Elf32_Shdr	*dstr;
...
int		Dwarf2_debug_del(debugs_t *list)
{
  debug_t	*d;
  debugs_t	*args;
  arg_t		*arg;
...
debug_t		*Dwarf2_debug_get_frm_addr(debugs_t *list, addr_t addr)
{
  debugs_t	*d;
  debugs_t	*first;
  debug_t	*elem;
...
debug_t		*Dwarf2_debug_get_frm_label(debugs_t *list, char *label)
{
  debugs_t	*d;
  debugs_t	*first;
  debug_t	*elem;
